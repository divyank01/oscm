...
SECRET_KEY = '6%n&aky%ja#p+500u+@wdslviy7xx1^g(*=i=ormws0@h#=(01'
...
#u can add files here in static local but on collectstatic it will be moved to static_files
STATICFILES_DIRS = (os.path.join(BASE_DIR,"static_local","static_root"),)
